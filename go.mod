module github.com/finishy1995/effibot-core

go 1.20

require (
	github.com/duke-git/lancet/v2 v2.2.7
	github.com/finishy1995/go-library v0.2.0
...
require (
	...
	github.com/finishy1995/codegenerator v0.0.0-20221211063759-605448222ea4 // indirect
